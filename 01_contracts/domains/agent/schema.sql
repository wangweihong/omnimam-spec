...
CREATE TABLE agents (
  ...
  CHECK ((kind = 'platform' AND workspace_type = 'agent') OR (kind = 'coding' AND workspace_type = 'studio')),
...
-- s1_refs: R-AGENT-002, R-AGENT-014, R-AGENT-018; source: 8.4 AgentInvocation, 21 Task Center 集成.
...
CREATE TABLE agent_workspace_bindings (
  ...
  authorization_summary_json TEXT NOT NULL DEFAULT '{}',
  UNIQUE (agent_id)
);
